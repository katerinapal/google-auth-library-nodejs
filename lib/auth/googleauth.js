...
var _jwtclient = require("./jwtclient.js");

var _computeclient = require("./computeclient.js");
...
var _iam = require("./iam.js");

var _jwtaccess = require("./jwtaccess.js");

var _oauth2client = require("./oauth2client.js");

var _refreshclient = require("./refreshclient.js");
 ...
 */
function GoogleAuth() {
  this.JWTClient = _jwtclient.JWT;
  this.ComputeClient = _computeclient.Compute;
 ...
 */
GoogleAuth.prototype.IAMAuth = _iam.IAMAuth;

/**
 * Convenience field mapping in the Compute credential type.
 */
GoogleAuth.prototype.Compute = _computeclient.Compute;

/**
 * Convenience field mapping in the JWT credential type.
 */
GoogleAuth.prototype.JWT = _jwtclient.JWT;

/**
 * Convenience field mapping in the JWT Access credential type.
 */
GoogleAuth.prototype.JWTAccess = _jwtaccess.JWTAccess;

/**
 * Convenience field mapping in the OAuth2 credential type.
 */
GoogleAuth.prototype.OAuth2 = _oauth2client.OAuth2Client;

/**
 * Convenience field mapping to the UserRefreshClient credential type.
 */
GoogleAuth.prototype.UserRefreshClient = _refreshclient.UserRefreshClient;
...
GoogleAuth.prototype._getGCEProjectId = function (_callback) {
  if (!this.transporter) {
    this.transporter = new _transporters.DefaultTransporter();
  }
...
GoogleAuth.prototype._checkIsGCE = function (callback) {
  ...
  if (that._checked_isGCE) {
    ...
    if (!that.transporter) {
      that.transporter = new _transporters.DefaultTransporter();
    }
...
GoogleAuth.prototype._getApplicationCredentialsFromFilePath = function (filePath, opt_callback) {
  ...
  if (!error) {
    try {
      ...
      error = createError(_util2.default.format('The file at %s does not exist, or it is not a file.', filePath), err);
    }
  }
  ...
  if (!error) {
    try {
      ...
      error = createError(_util2.default.format('Unable to read the file at %s.', filePath), err);
    }
  }
  if (error) {
...
GoogleAuth.prototype._pathJoin = function (item1, item2) {
  return _path2.default.join(item1, item2);
};
 ...
 * @constructor
 */
exports.GoogleAuth = mod_GoogleAuth;