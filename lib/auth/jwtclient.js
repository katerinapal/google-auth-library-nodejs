...
var _gtoken = require("gtoken");

var _gtoken2 = _interopRequireDefault(_gtoken);
 ...
 */
_util2.default.inherits(JWT, _oauth2client.OAuth2Client);
...
JWT.prototype.getRequestMetadata = function (opt_uri, metadataCb) {
  if (this.createScopedRequired() && opt_uri) {
    ...
    var alt = new _jwtaccess.JWTAccess(this.email, this.key);
    ...
    if (err) {
      ...
      return gToken.getToken(function (err, token) {
        return done(err, {
          access_token: token,
          token_type: 'Bearer',
          expiry_date: _gtoken2.default.expires_at
        });
      });
    }
  });
